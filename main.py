...
WEBHOOK_PROFILES_STANDARD = {
    ...
    'cmPitToDriver1': ("Lando's Engineer", "https://cdn-1.motorsport.com/images/mgl/0rGy3eG2/s1200/the-mclaren-pit-wall-1.webp"),
    'cmDriver2ToPit': ("Oscar Piastri", "https://mclaren.bloomreach.io/cdn-cgi/image/width=400,height=400,fit=crop/delivery/resources/content/gallery/mclaren-racing/team-members/oscar-piastri-team-landing-page-hero-2024.jpg"),
    'cmDriver1ToPit': ("Lando Norris", "https://mclaren.bloomreach.io/cdn-cgi/image/width=400,height=400,fit=crop/delivery/resources/content/gallery/mclaren-racing/team-members/lando-norris-team-landing-page-hero-2024.jpg")
}
...
def process_index(data):
    ...
    new_timestamps = list(set(timestamp for timestamp in timestamps if timestamp not in seen_timestamps))
